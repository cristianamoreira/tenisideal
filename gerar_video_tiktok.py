...
THEMES = [
    dict(key="sonhos", label="TÊNIS DOS SONHOS", small="SE DINHEIRO NÃO", big1="FOSSE", big2="PROBLEMA...",
         ...
         hook="Se dinheiro NÃO fosse problema, qual desses tênis você usaria? 👟🔥 Comenta o número 👇", tags=["supertenis", "maratona"]),
    dict(key="ate500", label="MELHORES ATÉ R$500", small="NÃO PRECISA GASTAR", big1="MAIS DE", big2="R$ 500",
         sub="esses provam o porquê 👇", select=sel_ate500,
         hook="Você NÃO precisa gastar mais de R$500 num bom tênis de corrida 👟💰 Qual levaria? 👇", tags=["custobeneficio", "tenisbarato"]),
    dict(key="amort", label="MÁXIMO AMORTECIMENTO", small="CORRE E SENTE", big1="DOR NO", big2="JOELHO?",
         sub="esses amortecem o impacto 👇", select=sel_amort,
         hook="Corre e sente DOR NO JOELHO? Esses tênis amortecem o impacto 👟☁️ Comenta 👇", tags=["amortecimento", "conforto"]),
    dict(key="leves", label="LEVES E RÁPIDOS", small="ESSES TÊNIS TE", big1="FAZEM", big2="VOAR",
         sub="leves feito pluma 👇", select=sel_leves,
         hook="Os tênis mais LEVES pra você correr mais rápido 👟⚡ Qual seu favorito? 👇", tags=["velocidade", "carbono"]),
    dict(key="iniciante", label="PRA QUEM TÁ COMEÇANDO", small="NÃO COMETA O ERRO", big1="DE TODO", big2="INICIANTE",
         sub="acerte no 1º tênis 👇", select=sel_iniciante,
         hook="O ERRO que todo iniciante comete ao comprar o primeiro tênis de corrida 👟🌱 Comenta 👇", tags=["iniciante", "corridainiciante"]),
